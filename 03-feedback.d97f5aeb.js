...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=e=>document.querySelector(e),l=e=>document.querySelectorAll(e),r=e=>console.log(e),o=e=>document.createElement(e),n=a('input[name="email"]'),s=a('textarea[name="message"]'),c=a('button[type="submit"]'),m=a(".feedback-form"),u="feedback-form-state",i=()=>{try{n.value=JSON.parse(localStorage.getItem(u)).email,s.value=JSON.parse(localStorage.getItem(u)).message}catch{r("Whoops!! Nothing to see here. No data in LocalStorage!")}},d=e=>{return/\S+@\S+\.\S+/.test(e)},g=()=>{let e={email:`${n.value}`,message:`${s.value}`};localStorage.setItem(u,JSON.stringify(e))},S=e=>{!0===d(n.value)?(e.preventDefault(),r(JSON.parse(localStorage.getItem(u))),m.reset(),localStorage.removeItem(u)):alert("Please type in correct email. Like this one => email@example.com")};i(),n.addEventListener("input",(0,e.default)(g,1e3)),s.addEventListener("input",(0,e.default)(g,1e3)),c.addEventListener("click",S);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.d97f5aeb.js.map